!> @brief Solution to the "Take as much as you need" MPI exercise.
PROGRAM main
    USE mpi
    ...
    IF (my_rank == 0) THEN
        value = 12345
        !> =====================================================================
        !> => ALLOCATE ENOUGH FOR AN INTEGER + THE SIZE OF THE BSEND OVERHEAD <=
        !> =====================================================================
        buffer_size_bytes = SIZEOF(value) + MPI_BSEND_OVERHEAD
