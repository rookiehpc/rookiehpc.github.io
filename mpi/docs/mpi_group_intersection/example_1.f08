...
PROGRAM main
    ...
    TYPE(MPI_Group) :: intersection_group
    INTEGER :: my_rank
    ...
    CALL MPI_Group_intersection(group_a, group_b, intersection_group)

    ! Get my rank in the communicator
    CALL MPI_Comm_rank(MPI_COMM_WORLD, my_rank)

    ! Create a communicator made of the processes in the intersection group
    CALL MPI_Comm_create(MPI_COMM_WORLD, intersection_group, new_communicator)
