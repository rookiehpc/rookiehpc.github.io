...
PROGRAM main
    ...
    TYPE(MPI_Group) :: difference_group
    ...
    CALL MPI_Group_difference(group_a, group_b, difference_group)

    ! Get my rank in the world group and the difference group
    CALL MPI_Group_rank(world_group, my_world_group_rank)
    CALL MPI_Group_rank(difference_group, my_difference_group_rank)
