...
PROGRAM main
    ...
    SELECT CASE (my_rank)
        CASE (0)
            ...
            CALL MPI_Issend(buffer(0), 1, MPI_INTEGER, 1, 0, MPI_COMM_WORLD, requests(0))
            ...
            CALL MPI_Issend(buffer(1), 1, MPI_INTEGER, 2, 0, MPI_COMM_WORLD, requests(1))
            ...
            CALL MPI_Issend(buffer(2), 1, MPI_INTEGER, 3, 0, MPI_COMM_WORLD, requests(2))
            ...
            CALL MPI_Waitsome(3, requests, index_count, indices, MPI_STATUSES_IGNORE)
