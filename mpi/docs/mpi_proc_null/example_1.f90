...
PROGRAM main
    ...
    CALL MPI_Isend(value_to_send, 1, MPI_INT, recipient_rank, 0, MPI_COMM_WORLD, request, ierror)
    ...
    value_received = -1
    CALL MPI_Recv(value_received, 1, MPI_INT, sender_rank, MPI_ANY_TAG, MPI_COMM_WORLD, MPI_STATUS_IGNORE, ierror)
