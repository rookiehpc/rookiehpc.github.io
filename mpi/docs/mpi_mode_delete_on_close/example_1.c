...
/**
 * @brief Illustrates how to specify that a file must be deleted upon closure.
 * @details This application illustrates how to indicate that a file used temporarily
 * must be deleted upon closure.
 **/
