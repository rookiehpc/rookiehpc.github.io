...
PROGRAM main
    ...
    IF (my_rank .EQ. 1) THEN
        ...
        CALL MPI_Ireduce_scatter(values, reduction_results, counts, MPI_INTEGER, MPI_SUM, MPI_COMM_WORLD, request, ierror)
        ...
        WRITE(*,'(A,I0,A,I0,A,I0,A)') '(MPI process ', my_rank, ') The sum I received are ', reduction_results(1), &
                                      ' and ', reduction_results(2), '.'
