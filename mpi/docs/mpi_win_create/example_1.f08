...
PROGRAM main
    ...
    IF (my_rank .EQ. 0) THEN
        ...
        CALL MPI_Get(remote_value, 1, MPI_INTEGER, 1, target_displacement, 1, MPI_INTEGER, window)

        ! Push my value into the first integer in MPI process 1 window
        target_displacement = 0
        CALL MPI_Put(my_value, 1, MPI_INTEGER, 1, target_displacement, 1, MPI_INTEGER, window)
    END IF
