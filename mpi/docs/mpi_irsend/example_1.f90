...
PROGRAM main
    ...
    SELECT CASE (my_rank)
        CASE (sender_rank)
            ...
            CALL MPI_Irsend(buffer_sent, 1, MPI_INTEGER, receiver_rank, 0, MPI_COMM_WORLD, request, ierror)
        ...
        CASE (receiver_rank)
            CALL MPI_Irecv(received, 1, MPI_INTEGER, sender_rank, 0, MPI_COMM_WORLD, request, ierror)
